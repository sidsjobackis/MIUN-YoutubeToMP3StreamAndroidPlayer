 ...
 * generated in the miun.player.converter package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetM3UStream_QNAME = new QName("http://converter.player.miun/", "getM3UStream");
    private final static QName _GetM3UStreamResponse_QNAME = new QName("http://converter.player.miun/", "getM3UStreamResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: miun.player.converter
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://converter.player.miun/", name = "getM3UStream")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://converter.player.miun/", name = "getM3UStreamResponse")
